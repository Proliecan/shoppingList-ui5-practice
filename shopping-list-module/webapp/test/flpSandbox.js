		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shopping List",
									"targetURL": "#slnsshoppinglistmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"slnsshoppinglistmodule-display": {
								"semanticObject": "slnsshoppinglistmodule",
								"action": "display",
								"description": "Fiori cpmpliant Shoppoing lsit",
								"title": "Shopping List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sl.ns.shoppinglistmodule",
									"url": sap.ui.require.toUrl("sl/ns/shoppinglistmodule")
								}
							}
						}
					}
